...
# Run the script:
# python -u multitask_classifier_bonus.py --use_gpu --local_files_only --option finetune --task multitask --hidden_dropout_prob 0.1 
# python -u multitask_classifier_task.py --use_gpu --local_files_only --option finetune --task sts --hidden_dropout_prob 0.1 --loss_function MNRL --add_smooth --transformation z_score
# python -u multitask_classifier_task.py --use_gpu --local_files_only --option finetune --task sst --hidden_dropout_prob 0.1 --add_smooth 
python -u multitask_classifier_task.py --use_gpu --local_files_only --option finetune --task qqp --hidden_dropout_prob 0.1 --loss_function MNRL --add_smooth 